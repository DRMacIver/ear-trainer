/**
 * Experimental exercises index page.
 */

export function renderExperimentalIndex(): void {
  const app = document.getElementById("app")!;

  app.innerHTML = `
    <a href="#/" class="back-link">&larr; Back to home</a>
    <h1>Experimental Exercises</h1>
    <p>Various ear training exercises in development.</p>

    <h2>Note Exercises</h2>
    <ul class="exercise-list">
      ...
      <li>
        <a href="#/exercises/note-id-quiz">
          <div class="title">Progressive Note ID (SRS)</div>
          <div class="description">
